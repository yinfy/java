...
/**
 * The persistent class for the personreg database table.
 * 
 */
@Entity
@NamedQuery(name="Personreg.findAll", query="SELECT p FROM Personreg p")
public class Personreg extends EntityImpl  implements Serializable {
	...
	public Personreg() {
		...
		creg.setShaddr("");
		creg.setShbirthday(cal.getTime());
		creg.setShcarr("");
		creg.setShemail("");
		creg.setShgender("男");
		creg.setShidno("");
		creg.setShlevel("");
		creg.setShidtype("身份证");
		creg.setShmobile("");
		creg.setShname("");
		creg.setShnat("汉族");
	...
	public String getFieldValue(String field){
		...
		switch(field){
			...
			case "capital":
				...
				break;
			case "capitalmodea":
				if(this.capitalmode.equals("以个人财产出资")){
					value = "√";
				}else{
					value = "　";
				}
			...
			case "shgender":
				...
				break;
			case "shbirthday":
				value = sf.format(this.shbirthday);
				break;
			case "shnat":
				value = this.shnat;
				break;
	...
	public Date getShbirthday() {
		return this.shbirthday;
	}

	public void setShbirthday(Date shbirthday) {
		this.shbirthday = shbirthday;
	}
