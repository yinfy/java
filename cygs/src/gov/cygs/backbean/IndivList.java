...
@ManagedBean 
@ViewScoped
public class IndivList extends Pager {
	@EJB DBM dbm;
	@EJB IndivService cregService;
	
	private List<Indivreg> cregList;
	private LazyDataModel model; 
	private Indivreg creg;
	private Indivreg selectedCreg;
	...
	public List<Indivreg> getCregList() {
		return cregList;
	}

	public void setCregList(List<Indivreg> cregList) {
	...
	public Indivreg getSelectedCreg() {
		return selectedCreg;
	}

	public void setSelectedCreg(Indivreg selectedCreg) {
